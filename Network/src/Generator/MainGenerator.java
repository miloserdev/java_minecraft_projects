...
import A_Main.Main;
import Generator.populator.RealisticConfig;
import Generator.populator.TreePopulator;
import Generator.populator.giantcaves.GiantCavePopulator;
...
public class MainGenerator extends ChunkGenerator {
	public List<BlockPopulator> getDefaultPopulators(World world) {
		...
		arrayList.add(new GiantCavePopulator(Main.getPlugin(), null));
		return arrayList;
	}
